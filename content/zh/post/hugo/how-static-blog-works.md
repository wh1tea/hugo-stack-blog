...
> 面向小白：拆解 wh1tea.github.io 这个纯静态博客的完整实现。读完你会明白从写一篇文章到读者看到它，每一步发生了什么。[^1]
...
正文就是普通 Markdown。frontmatter 的职责：给文章打标签、分类、定日期，构建脚本靠它生成目录。[^3]
...
- 想搭一个：创建 `<用户名>.github.io` 仓库，写第一篇 `.md`，push 即可[^5]

具体搭建步骤见 [GitHub Pages 博客搭建教程](setting-up-github-io-blog.md)。

[^1]: [项目源码](https://github.com/wh1tea/wh1tea.github.io) 本博客仓库

[^2]: [GitHub Pages 官方文档](https://docs.github.com/zh/pages) 托管与自定义域名

[^3]: [marked.js](https://marked.js.org/) Markdown 解析器

[^4]: [highlight.js](https://highlightjs.org/) 代码高亮

[^5]: [Markdown 语法指南](../tutorial/markdown-for-typora.md) 本站文章
